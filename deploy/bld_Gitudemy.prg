...
EXE_FILE		  =		  	"Gitudemy"
DCOM_ProgId       =			"Gitudemy.GitudemyServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Gitudemy/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Gitudemy/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Gitudemy/wc.wc?wwmaint~FileUpload"
