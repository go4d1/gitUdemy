...
***            Gitudemy.ini and you can customize operation there.
***
***            [ServerConfig]
***            Virtual=Gitudemy            
...
***
***    Assume: Called from GitudemyMain.prg startup code
***            with lcAction parameter:
***            DO GitudemyMain with "CONFIG"
***
***            Or launch your Exe from the Windows Command Line:
***            Gitudemy.exe config
***
***            or with a specific IIS site/virtual
***            Gitudemy.exe config "IIS://localhost/w3svc/12/root"
***
...
*** Try to read from Gitudemy.ini [ServerConfig] section
